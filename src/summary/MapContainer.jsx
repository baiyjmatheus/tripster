            ...
            this.props.trip.attractions.map(attraction => {
              ...
              return  <Marker
                  ...
                  icon={{
                    ...
                    url: '172.46.0.100:8080/img/step0002.png',
          ...
          }
          {
            this.props.trip.events.map(event => {
              return  <Marker
                  ...
                  icon={{
                    url: '172.46.0.100:8080/img/font-awesome_4-7-0_ticket_256_0_007dff_none.png',
                    anchor: new google.maps.Point(32, 32),
          ...
          }
          {
            this.props.trip.hotels.map(hotel => {
              return  <Marker
                  ...
                  icon={{
                    url: '172.46.0.100:8080/img/font-awesome_4-7-0_bed_256_0_007dff_none.png',
                    anchor: new google.maps.Point(32, 32),
